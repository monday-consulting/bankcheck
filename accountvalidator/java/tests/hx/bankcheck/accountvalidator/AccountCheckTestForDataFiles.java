 ...
 * 
 */
public class AccountCheckTestForDataFiles extends TestCase {

	private static final String CLASS_BASE_NAME = AccountCheckTestForDataFiles.class
			.getPackage().getName().concat(".impl.Checksum%s");

	private Properties validAccountNumbers;
	private Properties invalidAccountNumbers;

	public AccountCheckTestForDataFiles() {
