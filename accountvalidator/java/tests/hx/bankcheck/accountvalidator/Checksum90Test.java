...
public class Checksum90Test extends TestCase{
	...
	public void testValidate() throws Throwable {
		...
		assertTrue(checksum90.validate(validAccountNumberA1)
				&& (checksum90.getMethodFlag() <= 0));
		assertTrue(checksum90.validate(validAccountNumberA2)
				&& (checksum90.getMethodFlag() <= 0));
		// Should be valid but not using method A
		assertTrue(checksum90.validate(validAccountNumberNotUsingA)
				&& (checksum90.getMethodFlag() == 2));

		// Should be valid using method B
		assertTrue(checksum90.validate(validAccountNumberB1)
				&& (checksum90.getMethodFlag() <= 1));
		assertTrue(checksum90.validate(validAccountNumberB2)
				&& (checksum90.getMethodFlag() <= 1));
		// Should be valid but not using method B
		assertTrue(checksum90.validate(validAccountNumberNotUsingB1)
				&& (checksum90.getMethodFlag() == 2));
		assertTrue(checksum90.validate(validAccountNumberNotUsingB2)
				&& (checksum90.getMethodFlag() == 3));

		// Should be valid using method C
		assertTrue(checksum90.validate(validAccountNumberC1)
				&& (checksum90.getMethodFlag() <= 2));
		assertTrue(checksum90.validate(validAccountNumberC2)
				&& (checksum90.getMethodFlag() <= 2));
		// Should be valid but not using method C
		assertTrue(checksum90.validate(validAccountNumberNotUsingC1)
				&& (checksum90.getMethodFlag() == 3));
		assertTrue(checksum90.validate(validAccountNumberNotUsingC2)
				&& (checksum90.getMethodFlag() == 4));

		// Should be valid using method D
		assertTrue(checksum90.validate(validAccountNumberD1)
				&& (checksum90.getMethodFlag() <= 3));
		assertTrue(checksum90.validate(validAccountNumberD2)
				&& (checksum90.getMethodFlag() <= 3));
		// Should be valid but not using method D
		assertTrue(checksum90.validate(validAccountNumberNotUsingD1)
				&& (checksum90.getMethodFlag() == 4));
		assertTrue(checksum90.validate(validAccountNumberNotUsingD2)
				&& (checksum90.getMethodFlag() == 4));

		// Should be valid using method E
		assertTrue(checksum90.validate(validAccountNumberE1)
				&& (checksum90.getMethodFlag() <= 4));
		assertTrue(checksum90.validate(validAccountNumberE2)
				&& (checksum90.getMethodFlag() <= 4));

		// Should be valid using method F
		assertTrue(checksum90.validate(validAccountNumberF1)
				&& (checksum90.getMethodFlag() == 5));
		assertTrue(checksum90.validate(validAccountNumberF2)
				&& (checksum90.getMethodFlag() == 5));
