...
public class ChecksumB6Test extends AbstractChecksumTest {
	...
	public void testValidate() throws ValidationException {
		...
		int[] validAccountNumberAlternative2_1 = { 0, 4, 8, 7, 3, 1, 0, 0, 1,
				8 };
		...
		assertTrue((validator.validate(validAccountNumberAlternative1[0], null))
				&& (validator.getAlternative() == 0));
		assertTrue((validator.validate(validAccountNumberAlternative1[1], null))
				&& (validator.getAlternative() == 0));

		// Should be invalid using alternative 1
		assertFalse((validator.validate(invalidAccountNumberAlternative1[0],
				null)) && (validator.getAlternative() == 0));
		assertFalse((validator.validate(invalidAccountNumberAlternative1[1],
				null)) && (validator.getAlternative() == 0));

		// Should be valid using alternative 2
		assertTrue((validator.validate(validAccountNumberAlternative2_1,
				validBankNumberAlternative2_1))
